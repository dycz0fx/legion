...
namespace Realm {
  namespace FPGA {
    ...
    // {
    // public:
    //   FPGAMemcpy(FPGADevice *_fpga, FPGAMemcpyKind _kind);
    //   virtual ~FPGAMemcpy(void) { }
    //   virtual void execute() = 0;
    // public:
    //   FPGADevice *const fpga;
    // protected:
    //   FPGAMemcpyKind kind;
    // };

    // class FPGAMemcpy1D : public FPGAMemcpy {
    // public:
    //   FPGAMemcpy1D(FPGA *_fpga, void *_dst, const void *_src, size_t _bytes, FPGAMemcpyKind _kind, FPGACompletionNotification *_notification);
    //   virtual ~FPGAMemcpy1D(void);
